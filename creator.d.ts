	...
	*/
	...
	export class Component extends Object {		
		...
		*/
		...
		//  */
		// scheduleUpdate(target: object, priority: number, paused: boolean, updateFunc: Function): void;
		/**
	...
	export class VideoPlayer extends Component {//_RendererUnderSG
	...
	export class loader extends Pipeline {	
		static onProgress(completedCount: number, totalCount: number, item: any);
		...
		/**
		 * 获取依赖资源列表
		 * @param res {cc.Asset} 资源
		 * @param res {string} 资源目录下的url或资源uuid
		 * @returns uuidList
		 */
		static getDependsRecursively(assetOrUrlOrUuid:Asset | RawAsset | String ): string[];

		/**
		 * 获取资源的uuid
		 * @param assetOrUrl 
		 */
		static _getReferenceKey(asset: any): string;

		/**
		 * 获取资源数量
		 */
		static getResCount(): number;
		/**
...
declare module dragonBones {	
	...
	export class ArmatureDisplay extends cc._RendererUnderSG {		
		...
		*/
		...
		@param target target 
		*/
		addEventListener(eventType: string | dragonBones.EventObject, listener: Function, target: any): void;		
		/**
		!#en
...
declare namespace dragonBones {
    ...
    abstract class Slot extends TransformObject {
         ...
         * @see #display
         */
        setDisplay(value: any,type:number): void;
    }
}
declare namespace dragonBones {
    /**
